...
public class RiaFormosaNaoFiquesPorAquiFragment2 extends Fragment {

    private static final String htmlContent = "A área abrangida pelo Parque Natural da Ria Formosa é um local de nidificação para diversas espécies de aves (com importância nacional), é uma rota migratória e de invernada da avifauna (com importância internacional) e é uma zona húmida com interesse mundial.";
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaNaoFiquesPorAquiFragment2_to_riaFormosaNaoFiquesPorAquiFragment3);
            }
        });
