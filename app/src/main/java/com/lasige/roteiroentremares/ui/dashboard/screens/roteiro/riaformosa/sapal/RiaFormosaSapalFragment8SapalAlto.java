...
@AndroidEntryPoint
public class RiaFormosaSapalFragment8SapalAlto extends Fragment {
    ...
    private static final String QUERY = "SELECT * FROM especie_table_riaformosa " +
            "WHERE nomeCientifico = 'Limoniastrum monopetalum' OR " +
            "nomeCientifico = 'Artemisia campestris' OR " +
            "nomeCientifico = 'Juncus sp' OR " +
            "nomeCientifico = 'Halimione portulacoides' OR " +
            "nomeCientifico = 'Cistanche phelypaea'";
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaSapalFragment8SapalAlto_to_riaFormosaSapalFragment8SapalAltoPergunta);
            }
        });
        ...
        buttonSabiasQue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaSapalFragment8SapalAlto_to_riaFormosaSapalFragment8SapalAltoSabiasQue);
            }
        });
    }
    ...
    private void insertContent() {
        ...
        SpannableString link = ClickableString.makeLinkSpan("link", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open website
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://jb.utad.pt/flora"));
