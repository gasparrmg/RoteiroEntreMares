...
public class MaresFragment4 extends Fragment {

    private static final String htmlContent = "Tudo porque a força da maré é uma força diferencial - o que significa que vem das diferenças de gravidade na superfície da Terra." +
            "<br><br>" +
            "<b>Resulta assim:</b>" +
            "<br><br>" +
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_maresFragment4_to_maresFragment5);
            }
        });
    }
