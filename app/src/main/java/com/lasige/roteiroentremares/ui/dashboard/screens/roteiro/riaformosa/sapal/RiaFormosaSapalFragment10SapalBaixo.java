...
public class RiaFormosaSapalFragment10SapalBaixo extends Fragment {
    ...
    private static final String QUERY = "SELECT * FROM especie_table_riaformosa " +
            ...
            "nomeCientifico = 'Sarcocornia perennis' OR " +
            "nomeCientifico = 'Salicornia nitens' OR " +
            "nomeCientifico = 'Suaeda maritima' OR " +
            "nomeCientifico = 'Atriplex halimus' OR " +
            "nomeCientifico = 'Halimione portulacoides' OR " +
            "nomeCientifico = 'Limonium algarvense'";
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonSabiasQue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaSapalFragment10SapalBaixo_to_riaFormosaSapalFragment10SapalBaixoSabiasQue);
            }
        });
    }
