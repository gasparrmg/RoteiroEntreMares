...
public class RiaFormosaSapalFragment9SapalMedio extends Fragment {
    ...
    private static final String QUERY = "SELECT * FROM especie_table_riaformosa " +
            ...
            "nomeCientifico = 'Salicornia fruticosa' OR " +
            "nomeCientifico = 'Suaeda vera' OR " +
            "nomeCientifico = 'Halimione portulacoides'";
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaSapalFragment9SapalMedio_to_riaFormosaSapalFragment9SapalMedioPergunta);
            }
        });
