...
@AndroidEntryPoint
public class BiodiversidadeZonacaoInfralitoralFragment5Tarefa extends Fragment {

    private static final String ZONA = "Infralitoral";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_biodiversidade_zonacao_infralitoral5_tarefa, container, false);
                ...
                if (quadrado1Finished) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Substituir", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BiodiversidadeZonacaoInfralitoralFragment5TarefaDirections.ActionBiodiversidadeZonacaoInfralitoralFragment5TarefaToNewEditAvistamentoZonacaoFragment action = BiodiversidadeZonacaoInfralitoralFragment5TarefaDirections.actionBiodiversidadeZonacaoInfralitoralFragment5TarefaToNewEditAvistamentoZonacaoFragment(ZONA, 1);
