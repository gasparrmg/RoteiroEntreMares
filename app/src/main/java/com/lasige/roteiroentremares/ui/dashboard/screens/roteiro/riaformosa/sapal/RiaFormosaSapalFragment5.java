...
public class RiaFormosaSapalFragment5 extends Fragment {

    private static final String htmlContent = "Exemplos de adaptações das plantas halófitas:<br><br>" +
            "Para reter a água no interior do organismo<br>" +
            "- Folhas e caules suculentos (capazes de armazenar água)<br>" +
            "- Cutícula de revestimento dos órgãos aéreos espessa (evita a perda de água)<br>" +
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaSapalFragment5_to_riaFormosaSapalFragment6);
            }
        });
