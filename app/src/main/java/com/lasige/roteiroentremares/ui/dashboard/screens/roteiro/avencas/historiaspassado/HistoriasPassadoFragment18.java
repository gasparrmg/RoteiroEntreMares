...
public class HistoriasPassadoFragment18 extends Fragment {
    ...
    private int imageResourceId = R.drawable.img_historiaspassado_camadamargocarbonatada;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_historias_passado18, container, false);
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_historiasPassadoFragment18_to_historiasPassadoFragment19);
            }
        });
