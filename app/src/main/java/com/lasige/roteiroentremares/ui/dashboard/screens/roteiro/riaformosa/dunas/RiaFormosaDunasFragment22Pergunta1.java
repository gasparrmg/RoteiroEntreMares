...
@AndroidEntryPoint
public class RiaFormosaDunasFragment22Pergunta1 extends Fragment {
                ...
                if (textInputEditTextResposta.getText().toString().trim().length() == 0) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Navigation.findNavController(view).navigate(R.id.action_riaFormosaDunasFragment22Pergunta1_to_riaFormosaDunasFragment23Pergunta22);
                        }
                    });
    ...
    private void insertContent() {
        ...
        textViewContent.setText(HtmlCompat.fromHtml(
                "1. Quais as ameaças que identificas neste sistema dunar? Discute com os teus colegas e escreve a tua resposta no campo abaixo.",
                HtmlCompat.FROM_HTML_MODE_LEGACY
        ));
    }
}