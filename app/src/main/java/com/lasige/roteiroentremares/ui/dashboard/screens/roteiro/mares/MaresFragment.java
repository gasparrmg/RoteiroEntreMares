...
public class MaresFragment extends Fragment {
    ...
    private static final String htmlContent = "As marés são movimentos periódicos e previsíveis da subida e descida do nível das águas, que são causadas pela ação conjunta da lua e do sol, no entanto, a força gravitacional da lua é mais forte devido à sua maior proximidade.<br><br>A força de atração da lua sobre a Terra faz com que a Terra - e a água - seja projetada no lado mais próximo da Lua e também no lado mais distante dela.<br><br>Para compreenderes melhor este fenómeno vê o seguinte vídeo do Instituto Hidrográfico";
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_maresFragment_to_maresFragment2);
            }
        });
    }
