...
public class PoliticaPrivacidadeActivity extends AppCompatActivity {
    ...
    private static final String htmlContent = "Ao utilizar a aplicação Roteiro Entre-Marés, está a consentir com as práticas de recolha de informação da mesma, que estão descritas nesta Política de Privacidade. Se não consentir, deverá interromper a utilização da aplicação ou ajustar as permissões que são aqui referidas no seu dispositivo móvel.<br><br>" +
            ...
            "- <b>Câmara:</b> A câmara do dispositivo é utilizada para a captura de fotografias e vídeos para responder aos diferentes desafios pedagógicos que vão sendo feitos aos utilizadores. Os ficheiros gerados são guardados localmente no próprio dispositivo e poderão ser partilhados pelo utilizador com outros utilizadores mas nunca são recolhidos por nós.<br>" +
            ...
            "- <b>Microfone:</b> Durante as visitas aos locais, os utilizadores poderão criar gravações de áudio como forma de substituir simples notas de texto. Os ficheiros gerados são guardados localmente no próprio dispositivo e poderão ser partilhados pelo utilizador com outros utilizadores mas nunca são recolhidos por nós.<br><br>" +
            "<b>3. Partilha de dados entre utilizadores</b><br>" +
            "A aplicação Roteiro Entre-Marés dispõe de uma funcionalidade que permite aos utilizadores de tipo Aluno e Professor partilharem ficheiros (de texto, fotográficos, de vídeo ou de áudio) entre si, desde que pertençam à mesma turma, através de uma rede local Peer-to-Peer, recorrendo à tecnologia Wifi Direct, disponível para dispositivos Android. A partilha destes ficheiros só ocorre depois de uma ordem explícita por parte do próprio utilizador, na aplicação.<br>" +
            "Para garantir que apenas os membros da Turma têm acesso a estes ficheiros partilhados, o Professor terá de gerar um Código de Turma único e passá-lo aos seus alunos. Este código funciona como uma palavra-chave de acesso à rede e adiciona uma camada de segurança a esta componente. A funcionalidade só se encontra disponível na aplicação depois de submetido o código na área pessoal.<br>" +
            "Todos os dados recebidos por esta componente são apenas guardados localmente no dispositivo do utilizador e não são recolhidos por nós em altura alguma.<br><br>" +
            "<b>4. Como é que apaga todos os dados gerados?</b><br>" +
            ...
            "<b>5. Como é que pode contactar-nos?</b><br>" +
