...
@AndroidEntryPoint
public class RiaFormosaSapalFragment8SapalAltoPergunta extends Fragment {
                ...
                if (textInputEditTextResposta.getText().toString().trim().length() == 0) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Navigation.findNavController(view).navigate(R.id.action_riaFormosaSapalFragment8SapalAltoPergunta_to_riaFormosaSapalFragment9SapalMedio);
                        }
                    });
                    ...
                    Artefacto newTextArtefacto = new Artefacto(
                            ...
                            "Sapal alto - Observa bem o Sapal onde te encontras. Que plantas consegues identificar?",
