...
@AndroidEntryPoint
public class MaresFragment15 extends Fragment {

    private static final String htmlContent = "<b>ATENÇÃO:</b>" +
            "<br>" +
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mares15, container, false);
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dashboardViewModel.setMaresAsFinished();
