...
public class BiodiversidadeZonacaoMediolitoralInferiorFragment4 extends Fragment {
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_biodiversidadeZonacaoMediolitoralInferiorFragment4_to_biodiversidadeZonacaoMediolitoralInferiorFragment5Tarefa);
            }
        });
    }
