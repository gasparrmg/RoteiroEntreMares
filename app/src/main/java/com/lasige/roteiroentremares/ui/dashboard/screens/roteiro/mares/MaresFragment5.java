...
public class MaresFragment5 extends Fragment {

    private static final String htmlContent = "<b>Marés vivas</b> - ocorrem nos períodos de Lua Nova e Lua Cheia, quando o Sol e a Lua se encontram em conjuntura (i.e. quando estão diretamente alinhados). As forças gravitacionais estão no seu máximo originando marés de grande amplitude;" +
            "<br><br>" +
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_maresFragment5_to_maresFragment6);
            }
        });
    }
