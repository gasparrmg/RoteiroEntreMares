...
public class BiodiversidadeZonacaoFragment4Pergunta23 extends Fragment implements View.OnClickListener {

    private static final int[] correctAnswers = {1, 5, 6};
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!(isCorrect1 && isCorrect5 && isCorrect6)) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Navigation.findNavController(view).navigate(R.id.action_biodiversidadeZonacaoFragment4Pergunta23_to_biodiversidadeZonacaoFragment4Pergunta24);
                        }
                    });
    ...
    private void insertContent() {
        ...
        textViewContent.setText(HtmlCompat.fromHtml(
                "<b>2.3.</b> Há certos organismos dominantes, que definem andares ao longo da zona-entre-marés. Quem são eles na zona <b>Mediolitoral Inferior</b>?",
                HtmlCompat.FROM_HTML_MODE_LEGACY
        ));
