...
@AndroidEntryPoint
public class RiaFormosaSapalFragment9SapalMedioPergunta extends Fragment {
                ...
                if (textInputEditTextResposta.getText().toString().trim().length() == 0) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Navigation.findNavController(view).navigate(R.id.action_riaFormosaSapalFragment9SapalMedioPergunta_to_riaFormosaSapalFragment10SapalBaixo);
                        }
                    });
                    ...
                    Artefacto newTextArtefacto = new Artefacto(
                            ...
                            "Sapal médio - Observa bem o Sapal onde te encontras. Que plantas consegues identificar?",
