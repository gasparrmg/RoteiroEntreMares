...
public class BiodiversidadeZonacaoMediolitoralSuperiorFragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_biodiversidade_zonacao_mediolitoral_superior4, container, false);
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_biodiversidadeZonacaoMediolitoralSuperiorFragment4_to_biodiversidadeZonacaoMediolitoralSuperiorFragment5Tarefa);
            }
        });
    }
