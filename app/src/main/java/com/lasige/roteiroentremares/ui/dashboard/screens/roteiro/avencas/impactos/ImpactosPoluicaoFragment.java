...
public class ImpactosPoluicaoFragment extends Fragment {
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_impactosPoluicaoFragment_to_impactosPoluicaoFragment2);
            }
        });
    ...
    private void insertContent(View view) {
        ...
        SpannableString linkMicroplasticos = ClickableString.makeLinkSpan("microplásticos", new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Next fragment
                Navigation.findNavController(view).navigate(R.id.action_impactosPoluicaoFragment_to_impactosPoluicaoMicroplasticosFragment);
            }
        });
