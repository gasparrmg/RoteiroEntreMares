...
public class BiodiversidadeZonacaoMediolitoralSuperiorFragment extends Fragment {

    private static final String htmlContent = "Zona totalmente compreendida na zona das marés. Fica totalmente descoberta na maré-baixa, e totalmente submersa na maré-cheia.";
    ...
    private final int[] imageResourceIds = {
            R.drawable.img_biodiversidade_zonacao_mediolitoral_superior_1,
            R.drawable.img_biodiversidade_zonacao_mediolitoral_superior_2
    };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_biodiversidade_zonacao_mediolitoral_superior, container, false);
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_biodiversidadeZonacaoMediolitoralSuperiorFragment_to_biodiversidadeZonacaoMediolitoralSuperiorFragment2);
            }
        });
