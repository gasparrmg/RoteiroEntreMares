...
public class BiodiversidadeZonacaoInfralitoralFragment extends Fragment {

    private static final String htmlContent = "Estende-se desde o limite inferior do andar mediolitoral até à profundidade compatível  com a existência de algas (20-24m de profundidade). Na maré-baixa apenas é visível uma pequena franja.";
    ...
    private final int[] imageResourceIds = {
            R.drawable.img_guiadecampo_estreladomar_1,
            R.drawable.img_biodiversidade_zonacao_infralitoral_1
    };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_biodiversidade_zonacao_infralitoral, container, false);
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_biodiversidadeZonacaoInfralitoralFragment_to_biodiversidadeZonacaoInfralitoralFragment2);
            }
        });
