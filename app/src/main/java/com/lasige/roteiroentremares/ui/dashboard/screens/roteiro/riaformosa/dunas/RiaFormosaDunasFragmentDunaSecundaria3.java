...
public class RiaFormosaDunasFragmentDunaSecundaria3 extends Fragment {
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaDunasFragmentDunaSecundaria3_to_riaFormosaDunasFragmentDunaSecundaria4Tarefa);
            }
        });
    }
