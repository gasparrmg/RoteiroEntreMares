...
import com.lasige.roteiroentremares.ui.common.MediaPlayerResourceActivity;
...
public class RiaFormosaPradariasMarinhasFragment5 extends Fragment {

    private static final String htmlContent = "Para que tenhas  a sensação que estás a mergulhar numa pradaria marinha coloca os auscultadores e assiste a este pequeno vídeo.";

    private static final int videoResourceId = R.raw.vid_pradariasmarinhas;
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaPradariasMarinhasFragment5_to_riaFormosaPradariasMarinhasFragment6);
            }
        });
        ...
        buttonVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(MediaPlayerResourceActivity.INTENT_KEY_INFO, "Vídeo mergulho nas pradarias marinhas do estuário do Sado - Ocean Alive");
