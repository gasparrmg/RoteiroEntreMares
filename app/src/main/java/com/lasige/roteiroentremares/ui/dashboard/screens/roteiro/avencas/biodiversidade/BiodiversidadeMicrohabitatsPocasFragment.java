...
public class BiodiversidadeMicrohabitatsPocasFragment extends Fragment {
    ...
    private final int[] imageResourceIds = {
            ...
            R.drawable.img_biodiversidade_microhabitats_pocas_2
    };
    ...
    private void insertContent() {
        ...
        SpannableString linkInfralitoral = ClickableString.makeLinkSpan("infralitoral", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Show image infralitoral
                Intent intent = new Intent(getActivity(), ImageFullscreenActivity.class);
                intent.putExtra(ImageFullscreenActivity.INTENT_EXTRA_KEY, R.drawable.img_biodiversidade_zonacao_esquema);
        ...
        textViewContent.append(HtmlCompat.fromHtml(
                " (reproduzem o ambiente da zona que fica sempre submersa, mesmo na maré-baixa). Dependendo das características das poças (profundidade, tamanho, fundo de areia ou de rocha), podemos encontrar organismos de diferentes espécies.",
                HtmlCompat.FROM_HTML_MODE_LEGACY
        ));
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_biodiversidadeMicrohabitatsPocasFragment_to_biodiversidadeMicrohabitatsPocasFragment2);
            }
        });
