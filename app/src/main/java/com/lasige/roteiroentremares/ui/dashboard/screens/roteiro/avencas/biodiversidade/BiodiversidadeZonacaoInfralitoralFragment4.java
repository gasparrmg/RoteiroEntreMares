...
public class BiodiversidadeZonacaoInfralitoralFragment4 extends Fragment {
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_biodiversidadeZonacaoInfralitoralFragment42_to_biodiversidadeZonacaoInfralitoralFragment5Tarefa);
            }
        });
    }
