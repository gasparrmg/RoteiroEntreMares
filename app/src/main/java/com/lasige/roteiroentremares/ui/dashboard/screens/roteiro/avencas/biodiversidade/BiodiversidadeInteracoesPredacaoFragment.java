...
@AndroidEntryPoint
public class BiodiversidadeInteracoesPredacaoFragment extends Fragment {

    private static final int videoResourceId = R.raw.vid_biodiversidade_interacoes_predacao;

    private static final String htmlContent = "Um exemplo de predação com dois organismos característicos da plataforma rochosa da zona entre-marés, é a interação entre a estrela-do-mar e as lapas. A estrela-do-mar é carnívora alimentando-se de pequenos gastrópodes, como as lapas.<br>" +
            "<br>" +
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_biodiversidade_interacoes_predacao, container, false);
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dashboardViewModel.setBiodiversidadeInteracoesPredacaoAsFinished();
