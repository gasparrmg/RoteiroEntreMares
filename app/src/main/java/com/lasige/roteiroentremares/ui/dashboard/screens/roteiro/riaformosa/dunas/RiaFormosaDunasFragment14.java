...
public class RiaFormosaDunasFragment14 extends Fragment {

    private static final String htmlContent = "Para fazer face ao <b>soterramento pelas areias</b>:<br>" +
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaDunasFragment14_to_riaFormosaDunasFragment15);
            }
        });
        ...
        fabFullscreen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(ImageFullscreenActivity.INTENT_EXTRA_INFO, "Feno-das-areias e Estorno");
