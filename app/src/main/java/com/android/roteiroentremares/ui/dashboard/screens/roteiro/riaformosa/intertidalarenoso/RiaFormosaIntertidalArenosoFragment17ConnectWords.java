...
@AndroidEntryPoint
public class RiaFormosaIntertidalArenosoFragment17ConnectWords extends Fragment {
    ...
    private static final int maxCorrect1 = 2;
                ...
                if (!checkIfCompleted()) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Navigation.findNavController(view).navigate(R.id.action_riaFormosaIntertidalArenosoFragment17ConnectWords_to_riaFormosaIntertidalArenosoFragment18Menu);
                        }
                    });
