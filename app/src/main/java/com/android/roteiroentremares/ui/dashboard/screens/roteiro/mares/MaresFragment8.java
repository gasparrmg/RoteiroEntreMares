...
public class MaresFragment8 extends Fragment implements View.OnClickListener{

    private static final String htmlContent = "As marés altas ocorrem:";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mares11_pergunta_1, container, false);
                ...
                if (!isCorrect) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Navigation.findNavController(view).navigate(R.id.action_maresFragment8_to_maresFragment9);
                        }
                    });
