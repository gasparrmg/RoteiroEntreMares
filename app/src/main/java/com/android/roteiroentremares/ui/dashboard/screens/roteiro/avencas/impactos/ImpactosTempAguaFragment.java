...
public class ImpactosTempAguaFragment extends Fragment {
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_impactosTempAguaFragment_to_impactosTempAguaFragment2);
            }
        });
