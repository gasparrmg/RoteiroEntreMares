...
@AndroidEntryPoint
public class BiodiversidadeZonacaoMediolitoralInferiorFragment2 extends Fragment {

    private static final String htmlContent = "No horizonte inferior encontram-se as espécies:";
    private static final String QUERY = "SELECT * FROM especie_table_avencas " +
            "WHERE nomeCientifico = 'Balanus sp' OR " +
            "nomeCientifico = 'Pachygrapsus marmoratus' OR " +
            "nomeCientifico = 'Mytilus galloprovincialis' OR " +
            "nomeCientifico = 'Actinia equina' OR " +
            "nomeCientifico = 'Sabellaria alveolata' OR " +
            "nomeCientifico = 'Eulalia viridis' OR " +
            "nomeCientifico = 'Lithophyllum sp' OR " +
            "grupo = 'Aves' OR " +
            "nomeComum LIKE 'Algas%'";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_biodiversidade_zonacao_mediolitoral_inferior2, container, false);
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_biodiversidadeZonacaoMediolitoralInferiorFragment2_to_biodiversidadeZonacaoMediolitoralInferiorFragment3);
            }
        });
    }
