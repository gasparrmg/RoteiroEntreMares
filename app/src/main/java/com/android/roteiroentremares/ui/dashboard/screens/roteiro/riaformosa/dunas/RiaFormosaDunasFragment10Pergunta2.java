...
@AndroidEntryPoint
public class RiaFormosaDunasFragment10Pergunta2 extends Fragment {
            ...
            case R.id.item_text_to_speech:
                if (tts.isSpeaking()) {
                    ...
                    String text = HtmlCompat.fromHtml(
                            "Porque achas que se diz que “as dunas são montanhas nómadas”? Discute com os teus colegas e escreve a tua resposta no campo abaixo.",
    ...
    private void insertContent() {
        ...
        textViewContent.setText(HtmlCompat.fromHtml(
                "2. Porque achas que se diz que <b>“as dunas são montanhas nómadas”</b>? Discute com os teus colegas e escreve a tua resposta no campo abaixo.",
                HtmlCompat.FROM_HTML_MODE_LEGACY
        ));
    }
}