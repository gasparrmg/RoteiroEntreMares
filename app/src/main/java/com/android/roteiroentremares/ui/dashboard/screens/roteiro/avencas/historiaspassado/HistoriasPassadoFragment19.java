...
public class HistoriasPassadoFragment19 extends Fragment {
    ...
    private int imageResourceId = R.drawable.img_historiaspassado_calcariosnodulares;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_historias_passado19, container, false);
            ...
            case R.id.item_text_to_speech:
                if (tts.isSpeaking()) {
                    ...
                    String text = HtmlCompat.fromHtml(
                            "Calcários nodulares ricos em fósseis, da Praia das Avencas",
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_historiasPassadoFragment19_to_historiasPassadoFragment20);
            }
        });
