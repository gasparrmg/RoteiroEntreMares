...
@AndroidEntryPoint
public class RiaFormosaDunasFragmentZonaInterdunar2 extends Fragment {

    private static final String htmlContent = "<b>Dirige-te para a zona mais próxima do mar</b><br><br>" +
            "Na <b>zona interdunar</b> propriamente dita podes encontrar:";

    private static final String QUERY = "SELECT * FROM especie_table_riaformosa " +
            "WHERE nomeCientifico = 'Ononis variegata' OR " +
            "nomeCientifico = 'Medicago littoralis' OR " +
            "nomeCientifico = 'Hypecoum procumbens' OR " +
            "nomeCientifico = 'Paronychia argentea'";
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaDunasFragmentZonaInterdunar2_to_riaFormosaDunasFragmentZonaInterdunar3);
            }
        });
    }
