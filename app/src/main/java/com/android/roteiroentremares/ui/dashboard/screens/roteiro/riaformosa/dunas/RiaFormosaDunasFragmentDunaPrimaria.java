...
@AndroidEntryPoint
public class RiaFormosaDunasFragmentDunaPrimaria extends Fragment {

    private static final String htmlContent = "<b>Dirige-te para a zona mais interior.</b><br><br>" +
            "As espécies vegetais mais características nas dunas primárias são:";

    private static final String QUERY = "SELECT * FROM especie_table_riaformosa " +
            "WHERE nomeCientifico = 'Ammophila arenaria' OR " +
            "nomeCientifico = 'Elymus farctus' OR " +
            "nomeCientifico = 'Euphorbia paralias' OR " +
            "nomeCientifico = 'Otanthus maritimus' OR " +
            "nomeCientifico = 'Calystegia soldanella'";
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaDunasFragmentDunaPrimaria_to_riaFormosaDunasFragmentDunaPrimaria2);
            }
        });
    }
