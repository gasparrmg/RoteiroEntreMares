...
public class NaoFiquesPorAquiFragment2 extends Fragment {
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_naoFiquesPorAquiFragment2_to_naoFiquesPorAquiFragment3);
            }
        });
    }
    ...
    private void insertContent() {
        ...
        textViewContent.setText(HtmlCompat.fromHtml(
                "A AMP das Avencas é considerada uma área litoral muito rica por servir de habitat a uma grande variedade de espécies. No entanto esta é também muito frágil por estar sujeita a fatores físicos severos como por exemplo a força das ondas e os ciclos de marés. Mas os fatores que exercem maior pressão sobre este ecossistema são de origem humana, nomeadamente o pisoteio excessivo, a pesca e apanha não autorizada, a remoção de plantas necessárias para fixar o solo  das arribas e o lixo deixado na praia.",
                HtmlCompat.FROM_HTML_MODE_LEGACY
        ));
