...
public class BiodiversidadeInteracoesHerbivoriaFragment3 extends Fragment {

    private static final String htmlContent = "A hipótese de o limite superior deste tapete de algas vermelhas ser determinado por moluscos herbívoros foi testada. Os gastrópodes (lapas) foram excluídos recorrendo ao uso de redes, e utilizaram-se ainda controlos para testar o uso da rede (“meia-rede”) e controlos sem qualquer manipulação.";
    ...
    private int imageResourceId = R.drawable.img_biodiversidade_interacoes_herbivoria_desenho;
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_biodiversidadeInteracoesHerbivoriaFragment3_to_biodiversidadeInteracoesHerbivoriaFragment4);
            }
        });
