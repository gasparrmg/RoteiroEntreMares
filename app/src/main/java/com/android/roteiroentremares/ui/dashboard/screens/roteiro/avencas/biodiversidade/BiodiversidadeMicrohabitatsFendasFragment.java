...
public class BiodiversidadeMicrohabitatsFendasFragment extends Fragment implements EasyPermissions.PermissionCallbacks {
    ...
    private final int[] imageResourceIds = {
            R.drawable.img_biodiversidade_microhabitats_fendas_1,
            R.drawable.img_biodiversidade_microhabitats_fendas_2
    };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_biodiversidade_microhabitats_fendas, container, false);
