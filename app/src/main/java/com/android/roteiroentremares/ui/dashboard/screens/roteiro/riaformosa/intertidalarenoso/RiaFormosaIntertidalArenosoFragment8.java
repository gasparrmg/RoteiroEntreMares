...
public class RiaFormosaIntertidalArenosoFragment8 extends Fragment {

    private static final String htmlContent = "A topografia irregular contribui, algumas vezes, para que haja enclaves de outras zonas (sobretudo do infralitoral), originando as poças-de-maré.<br><br>" +
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaIntertidalArenosoFragment8_to_riaFormosaIntertidalArenosoFragment9);
            }
        });
    }
