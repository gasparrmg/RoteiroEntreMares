...
@AndroidEntryPoint
public class BiodiversidadeMicrohabitatsPocasFragment3 extends Fragment {

    private static final String htmlContent = "Algumas das espécies mais comuns nas poças de maré:";
    private static final String QUERY = "SELECT * FROM especie_table_avencas " +
            ...
            "nomeCientifico = 'Coryphoblennius galerita' OR " +
            "nomeCientifico = 'Gobius cobitis' OR " +
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_biodiversidade_microhabitats_pocas3, container, false);
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_biodiversidadeMicrohabitatsPocasFragment3_to_biodiversidadeMicrohabitatsPocasFragment4Tarefa);
            }
        });
    }
