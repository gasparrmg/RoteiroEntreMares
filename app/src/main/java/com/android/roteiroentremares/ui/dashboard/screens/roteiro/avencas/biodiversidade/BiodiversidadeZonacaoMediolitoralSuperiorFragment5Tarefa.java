...
@AndroidEntryPoint
public class BiodiversidadeZonacaoMediolitoralSuperiorFragment5Tarefa extends Fragment {

    private static final String ZONA = "Mediolitoral superior";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_biodiversidade_zonacao_mediolitoral_superior5_tarefa, container, false);
                ...
                if (quadrado1Finished) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Substituir", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BiodiversidadeZonacaoMediolitoralSuperiorFragment5TarefaDirections.ActionBiodiversidadeZonacaoMediolitoralSuperiorFragment5TarefaToNewEditAvistamentoZonacaoFragment action = BiodiversidadeZonacaoMediolitoralSuperiorFragment5TarefaDirections.actionBiodiversidadeZonacaoMediolitoralSuperiorFragment5TarefaToNewEditAvistamentoZonacaoFragment(ZONA, 1);
            ...
            public void onClick(View v) {
                ...
                if (!(quadrado1Finished && quadrado2Finished && quadrado3Finished)) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Navigation.findNavController(view).navigate(R.id.action_biodiversidadeZonacaoMediolitoralSuperiorFragment5Tarefa_to_biodiversidadeZonacaoMediolitoralInferiorFragment);
                        }
                    });
