...
public class MaresFragment6 extends Fragment {

    private static final String htmlContent = "Enquanto que a rotação da Terra ocorre num período de 24 horas, a lua faz a sua viagem em redor da Terra em 27,3 dias. Em 24 horas, a lua moveu-se o suficiente, para levar mais 50 minutos para que qualquer ponto específico da Terra “alcance” a lua.<br><br>" +
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_maresFragment6_to_maresFragment7);
            }
        });
    }
