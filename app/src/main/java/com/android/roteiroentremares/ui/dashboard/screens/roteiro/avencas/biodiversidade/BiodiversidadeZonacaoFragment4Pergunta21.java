...
public class BiodiversidadeZonacaoFragment4Pergunta21 extends Fragment implements View.OnClickListener {
        ...
        switch (id) {
            case R.id.item_text_to_speech:
                if (tts.isSpeaking()) {
                    ...
                    String text = "Há certos organismos dominantes, que definem andares ao longo da zona-entre-marés. Quem são eles na zona Supralitoral?";
                ...
                if (!isCorrect) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Navigation.findNavController(view).navigate(R.id.action_biodiversidadeZonacaoFragment4Pergunta21_to_biodiversidadeZonacaoFragment4Pergunta22);
                        }
                    });
    ...
    private void insertContent() {
        ...
        textViewContent.setText(HtmlCompat.fromHtml(
                "<b>2.1.</b> Há certos organismos dominantes, que definem andares ao longo da zona-entre-marés. Quem são eles na zona <b>Supralitoral</b>?",
        ...
        if (!isCorrect) {
            ...
            switch (v.getId()) {
                ...
                case R.id.cardview_answer4:
                    isCorrect = ImageQuestionUtils.isCorrect(getContext(), textViewAnswer4, cardViewAnswer4,4, 2);
                    break;
                case R.id.cardview_answer5:
                    isCorrect = ImageQuestionUtils.isCorrect(getContext(), textViewAnswer5, cardViewAnswer5,5, 2);
                    break;
                case R.id.cardview_answer6:
                    isCorrect = ImageQuestionUtils.isCorrect(getContext(), textViewAnswer6, cardViewAnswer6,6, 2);
                    break;
                case R.id.cardview_answer7:
                    isCorrect = ImageQuestionUtils.isCorrect(getContext(), textViewAnswer7, cardViewAnswer7,7, 2);
                    break;
                default:
                    break;
            }
