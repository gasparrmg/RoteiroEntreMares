...
@AndroidEntryPoint
public class HistoriasPassadoFragment8 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_historias_passado8, container, false);
            ...
            case R.id.item_text_to_speech:
                if (tts.isSpeaking()) {
                    ...
                    String text = HtmlCompat.fromHtml(
                            "Tendo em conta o ambiente onde estes organismos ocorrem, como achas que terá sido o ambiente neste local (paleoambiente)? Escreve a tua resposta no campo abaixo.",
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Navigation.findNavController(view).navigate(R.id.action_historiasPassadoFragment8_to_historiasPassadoFragment9);
            }
        });
    ...
    private void insertContent() {
        ...
        textViewContent.setText(HtmlCompat.fromHtml(
                "Tendo em conta o ambiente onde estes organismos ocorrem, como achas que terá sido o ambiente neste local (paleoambiente)?",
                HtmlCompat.FROM_HTML_MODE_LEGACY
        ));
    }
}