...
public class MaresFragment9 extends Fragment {

    private static final String htmlContent = "A lua surge Nova (escura) quando está entre a Terra e o sol e Cheia quando é a Terra que está entre a lua e o sol. Em ambos os casos, a atração gravitacional do sol na Terra é adicionada à atração gravitacional da lua na Terra., o que faz com que as marés se tornem ainda mais altas – <b>Marés vivas</b><br><br>" +
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_maresFragment9_to_maresFragment10);
            }
        });
    }
