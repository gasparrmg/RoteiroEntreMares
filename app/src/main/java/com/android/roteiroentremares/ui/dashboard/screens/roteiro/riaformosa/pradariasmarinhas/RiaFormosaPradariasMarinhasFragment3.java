...
public class RiaFormosaPradariasMarinhasFragment3 extends Fragment {

    private static final String htmlContent = "A Ria Formosa é um dos locais de eleição para o desenvolvimento destas plantas marinhas, também conhecidas como Sebas.<br>" +
            "Clica no botão abaixo para conheceres o mapa de Pradarias Marinhas em Portugal.";

    private static final int imageResourceId = R.drawable.img_riaformosa_pradariasmarinhas_1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_riaformosa_pradariasmarinhas3, container, false);
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaPradariasMarinhasFragment3_to_riaFormosaPradariasMarinhasFragment4);
            }
        });
