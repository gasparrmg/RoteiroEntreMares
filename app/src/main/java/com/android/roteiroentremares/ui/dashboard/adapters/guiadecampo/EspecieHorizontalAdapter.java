...
public class EspecieHorizontalAdapter extends RecyclerView.Adapter<EspecieHorizontalAdapter.EspecieHolder> {
    ...
    public EspecieHorizontalAdapter(Context context, int spot) {
    ...
    public EspecieHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.biodiversidade_microhabitats_pocas_especie_item, parent, false);
