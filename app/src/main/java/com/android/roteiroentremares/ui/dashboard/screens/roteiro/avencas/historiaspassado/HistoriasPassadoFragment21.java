                ...
                if (ttsEnabled) {
                    if (tts.isSpeaking()) {
                        ...
                        String text = HtmlCompat.fromHtml(
                                "<b>TAREFA: </b>" +
                                        "No caminho de volta para a Plataforma das Avencas, observa com atenção a arriba.<br><br>Só deverás passar para o próximo ecrã quando te encontrares perto do local.",
