...
@AndroidEntryPoint
public class RiaFormosaDunasFragmentDunaSecundaria2 extends Fragment {

    private static final String htmlContent = "<b>Dirige-te para a zona das dunas mais interiores</b><br><br>" +
            "As espécies vegetais mais características na zona limite para o sub-bosque/mata são:";

    private static final String QUERY = "SELECT * FROM especie_table_riaformosa " +
            "WHERE nomeCientifico = 'Anagallis monelli' OR " +
            "nomeCientifico = 'Corrigiola littoralis' OR " +
            "nomeCientifico = 'Pycnocomon rutifolium'";
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaDunasFragmentDunaSecundaria2_to_riaFormosaDunasFragmentDunaSecundaria3);
            }
        });
    }
