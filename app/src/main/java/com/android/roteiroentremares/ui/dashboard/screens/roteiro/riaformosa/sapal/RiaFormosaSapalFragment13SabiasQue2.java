...
import com.android.roteiroentremares.ui.dashboard.adapters.guiadecampo.EspecieRiaFormosaGridAdapter;
...
@AndroidEntryPoint
public class RiaFormosaSapalFragment13SabiasQue2 extends Fragment {

    private static final String htmlContent = "Fica a saber mais sobre as espécies de aves que consegues observar no local onde te encontras!";

    private static final String QUERY = "SELECT * FROM especie_table_riaformosa " +
            "WHERE grupo = 'Aves Limícolas (Chordata)'";
    ...
    private EspecieRiaFormosaGridAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_riaformosa_sapal13_sabiasque2, container, false);
        ...
        adapter.setOnItemClickListener(new EspecieRiaFormosaGridAdapter.OnItemClickListener() {
            @Override
    ...
    private void initViews(View view) {
        ...
        adapter = new EspecieRiaFormosaGridAdapter(getContext(), 0);
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).popBackStack(R.id.riaFormosaSapalFragment13 ,false);
            }
        });
    }
