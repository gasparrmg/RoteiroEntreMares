...
public class RiaFormosaSapalFragment12 extends Fragment {
    ...
    private static final int imageResourceId = R.drawable.img_riaformosa_guiadecampo_caranguejoviolinista_1;
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaSapalFragment12_to_riaFormosaSapalFragment13);
            }
        });
