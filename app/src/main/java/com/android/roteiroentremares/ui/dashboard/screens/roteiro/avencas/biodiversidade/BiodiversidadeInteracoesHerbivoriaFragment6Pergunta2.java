...
@AndroidEntryPoint
public class BiodiversidadeInteracoesHerbivoriaFragment6Pergunta2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_biodiversidade_interacoes_herbivoria6_pergunta_2, container, false);
            ...
            case R.id.item_text_to_speech:
                if (tts.isSpeaking()) {
                    ...
                    String text = HtmlCompat.fromHtml(
                            "A que correspondem os outros dois tratamentos representados no gráfico e qual achas que é a sua função? Discute com os teus colegas e escreve a tua resposta no campo abaixo.",
