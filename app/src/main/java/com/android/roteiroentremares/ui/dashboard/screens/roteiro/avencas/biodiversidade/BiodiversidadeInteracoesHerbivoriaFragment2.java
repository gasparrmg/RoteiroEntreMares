...
public class BiodiversidadeInteracoesHerbivoriaFragment2 extends Fragment {
    ...
    private static final String htmlContent = "Que fatores condicionam os limites de distribuição vertical?<br><br>" +
    ...
    private void insertContent() {
        ...
        textViewTitle2.setText(HtmlCompat.fromHtml(
                "Influência da herbivoria nas comunidades\n(adaptado de Boaventura, 2000)",
                HtmlCompat.FROM_HTML_MODE_LEGACY
        ));
