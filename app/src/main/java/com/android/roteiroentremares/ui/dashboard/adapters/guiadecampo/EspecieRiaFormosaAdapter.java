...
public class EspecieRiaFormosaAdapter extends RecyclerView.Adapter<EspecieRiaFormosaAdapter.EspecieHolder> {
    ...
    public EspecieRiaFormosaAdapter(Context context, int spot) {
