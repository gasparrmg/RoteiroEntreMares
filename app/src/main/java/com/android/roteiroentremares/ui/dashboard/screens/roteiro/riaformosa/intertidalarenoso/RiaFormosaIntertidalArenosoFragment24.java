...
@AndroidEntryPoint
public class RiaFormosaIntertidalArenosoFragment24 extends Fragment {

    private static final String htmlContent = "Investiga como é que cada um destes fatores pode contribuir para a destruição deste habitat...<br>" +
            "<br>" +
            "Discute com os teus colegas formas de reduzir o seu impacto...";
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // finish dunas
                dashboardViewModel.setRiaFormosaIntertidalArenosoAsFinished();
