...
@AndroidEntryPoint
public class RiaFormosaDunasFragmentZonaInterdunar extends Fragment {

    private static final String htmlContent = "<b>Dirige-te para a zona mais próxima do mar</b><br><br>" +
            "Na <b>parte interior da duna primária</b> e no início da <b>zona interdunar</b> podes encontrar:";

    private static final String QUERY = "SELECT * FROM especie_table_riaformosa " +
            "WHERE nomeCientifico = 'Thymus carnosus' OR " +
            "nomeCientifico = 'Helichrysum italicum' OR " +
            "nomeCientifico = 'Pseudorlaya pumila'";
    ...
    private void initViews(View view) {
        ...
        buttonSabiasQue.setText("Endemismo");
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaDunasFragmentZonaInterdunar_to_riaFormosaDunasFragmentZonaInterdunar2);
            }
        });
        ...
        buttonSabiasQue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaDunasFragmentZonaInterdunar_to_riaFormosaDunasFragmentZonaInterdunarEndemismo);
            }
        });
    }
