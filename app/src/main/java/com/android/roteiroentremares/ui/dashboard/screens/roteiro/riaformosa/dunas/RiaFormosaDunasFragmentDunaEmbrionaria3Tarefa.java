...
import com.android.roteiroentremares.ui.dashboard.screens.roteiro.avencas.biodiversidade.BiodiversidadeZonacaoSupralitoralFragment5TarefaDirections;
...
@AndroidEntryPoint
public class RiaFormosaDunasFragmentDunaEmbrionaria3Tarefa extends Fragment {

    private static final String ZONA = "Duna embrionária";
                ...
                if (quadrado1Finished) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Substituir", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            RiaFormosaDunasFragmentDunaEmbrionaria3TarefaDirections.ActionRiaFormosaDunasFragmentDunaEmbrionaria3TarefaToNewAvistamentoDunasFragment action = RiaFormosaDunasFragmentDunaEmbrionaria3TarefaDirections.actionRiaFormosaDunasFragmentDunaEmbrionaria3TarefaToNewAvistamentoDunasFragment(ZONA, 1);
                ...
                if (quadrado2Finished) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Substituir", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            RiaFormosaDunasFragmentDunaEmbrionaria3TarefaDirections.ActionRiaFormosaDunasFragmentDunaEmbrionaria3TarefaToNewAvistamentoDunasFragment action = RiaFormosaDunasFragmentDunaEmbrionaria3TarefaDirections.actionRiaFormosaDunasFragmentDunaEmbrionaria3TarefaToNewAvistamentoDunasFragment(ZONA, 2);
                            Navigation.findNavController(view).navigate(action);
                        }
                    });
                    materialAlertDialogBuilder.setNegativeButton("Fechar", new DialogInterface.OnClickListener() {
                ...
                if (quadrado3Finished) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Substituir", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            RiaFormosaDunasFragmentDunaEmbrionaria3TarefaDirections.ActionRiaFormosaDunasFragmentDunaEmbrionaria3TarefaToNewAvistamentoDunasFragment action = RiaFormosaDunasFragmentDunaEmbrionaria3TarefaDirections.actionRiaFormosaDunasFragmentDunaEmbrionaria3TarefaToNewAvistamentoDunasFragment(ZONA, 3);
                            Navigation.findNavController(view).navigate(action);
                        }
                    });
                    materialAlertDialogBuilder.setNegativeButton("Fechar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!(quadrado1Finished && quadrado2Finished && quadrado3Finished)) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            dashboardViewModel.setRiaFormosaDunasDunaEmbrionariaAsFinished();
