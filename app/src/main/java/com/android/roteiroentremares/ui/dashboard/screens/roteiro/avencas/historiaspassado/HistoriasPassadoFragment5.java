...
@AndroidEntryPoint
public class HistoriasPassadoFragment5 extends Fragment implements EasyPermissions.PermissionCallbacks {

    private final int imageResourceId = R.drawable.img_historiaspassado_local1;
    private final String spotCoordinates = "38.68979,-9.36356";
    private final double spotLatitude = 38.68979;
    private final double spotLongitude = -9.36356;
