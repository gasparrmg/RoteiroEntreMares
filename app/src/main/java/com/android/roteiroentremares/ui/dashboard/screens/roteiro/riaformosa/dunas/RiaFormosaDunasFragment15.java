...
public class RiaFormosaDunasFragment15 extends Fragment {

    private static final String htmlContent = "Para fazer face ao vento <b>marítimo forte</b>:<br>" +
            "- Tufos de colmos (caule cilíndrico com os nós bem marcados) flexíveis<br>" +
            "- Formação de moitas (hábito amoitado ou almofadado)<br>" +
            "- Textura coriácea (contribui para a planta estar ereta)";

    private static final int imageResourceId = R.drawable.img_riaformosa_dunas_15_ilustracao;
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaDunasFragment15_to_riaFormosaDunasFragment16);
            }
        });
        ...
        fabFullscreen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(ImageFullscreenActivity.INTENT_EXTRA_INFO, "Cardo-marítimo");
