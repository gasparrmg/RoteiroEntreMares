...
@AndroidEntryPoint
public class RiaFormosaIntertidalArenosoFragment6 extends Fragment {
    ...
    private static final String QUERY = "SELECT * FROM especie_table_riaformosa " +
            "WHERE nomeCientifico = 'Chthamalus spp' OR " +
            "nomeCientifico = 'Balanus sp' OR " +
            ...
            "nomeCientifico = 'Pagurus bernhardus' OR " +
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Glide.with(getActivity())
                .load(R.drawable.img_intertidalarenoso_mediolitoral_ilustracao)
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaIntertidalArenosoFragment6_to_riaFormosaIntertidalArenosoFragment7);
            }
        });
    }
