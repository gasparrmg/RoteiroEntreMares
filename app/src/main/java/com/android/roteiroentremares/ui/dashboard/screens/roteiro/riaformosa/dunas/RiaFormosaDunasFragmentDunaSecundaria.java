...
@AndroidEntryPoint
public class RiaFormosaDunasFragmentDunaSecundaria extends Fragment {

    private static final String htmlContent = "<b>Dirige-te para a zona das dunas mais interiores</b><br><br>" +
            "As espécies vegetais mais características nas dunas secundárias são:";

    private static final String QUERY = "SELECT * FROM especie_table_riaformosa " +
            "WHERE nomeCientifico = 'Otanthus maritimus' OR " +
            "nomeCientifico = 'Eryngium maritimum' OR " +
            "nomeCientifico = 'Pancratium maritimum'";
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaDunasFragmentDunaSecundaria_to_riaFormosaDunasFragmentDunaSecundaria2);
            }
        });
    }
