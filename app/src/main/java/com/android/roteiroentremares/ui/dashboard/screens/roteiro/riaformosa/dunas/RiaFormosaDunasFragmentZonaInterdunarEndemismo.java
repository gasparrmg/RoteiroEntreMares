...
public class RiaFormosaDunasFragmentZonaInterdunarEndemismo extends Fragment {

    private static final String htmlContent = "Em biologia, chamam-se endemismos a espécies que se desenvolveram numa região restrita. No caso de um endemismo ibérico, significa que essa espécie apenas existe na Península Ibérica.<br><br>" +
            "Para ficares a conhecer as espécies endémicas de Portugal, clica aqui.";
    ...
    private void insertContent() {
        ...
        textViewContent.setText(HtmlCompat.fromHtml(
                "Em biologia, chamam-se endemismos a espécies que se desenvolveram numa região restrita. No caso de um endemismo ibérico, significa que essa espécie apenas existe na Península Ibérica.<br><br>" +
                        "Para ficares a conhecer as espécies endémicas de Portugal, visita este ",
                HtmlCompat.FROM_HTML_MODE_LEGACY
        ));
