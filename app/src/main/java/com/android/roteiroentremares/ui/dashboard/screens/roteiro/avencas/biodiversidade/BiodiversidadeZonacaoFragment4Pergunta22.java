...
public class BiodiversidadeZonacaoFragment4Pergunta22 extends Fragment implements View.OnClickListener {

    private static final int[] correctAnswers = {3, 4};
        ...
        switch (id) {
            case R.id.item_text_to_speech:
                if (tts.isSpeaking()) {
                    ...
                    String text = "Há certos organismos dominantes, que definem andares ao longo da zona-entre-marés. Quem são eles na zona Mediolitoral Superior?";
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_biodiversidadeZonacaoFragment4Pergunta22_to_biodiversidadeZonacaoFragment4Pergunta23);
            }
        });
    ...
    private void insertContent() {
        ...
        textViewContent.setText(HtmlCompat.fromHtml(
                "<b>2.2.</b> Há certos organismos dominantes, que definem andares ao longo da zona-entre-marés. Quem são eles na zona <b>Mediolitoral Superior</b>?",
