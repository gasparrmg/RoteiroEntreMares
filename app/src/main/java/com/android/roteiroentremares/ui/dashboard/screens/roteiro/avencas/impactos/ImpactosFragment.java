...
public class ImpactosFragment extends Fragment {
            ...
            case R.id.item_text_to_speech:
                if (tts.isSpeaking()) {
                    ...
                    String text = HtmlCompat.fromHtml(
                            "Independentemente do local onde vivamos no planeta, todos sofremos a influência do Oceano e as nossas ações também o influenciam. " +
                                    "O oceano fornece-nos recursos básicos, como o oxigénio, a água doce e muito do nosso alimento. Também possui outros recursos minerais, energéticos e medicamentos. " +
                                    "O oceano também está relacionado com muitas atividades socioeconómicas: a pesca, o comércio, a navegação, turismo e viagens.",
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_impactosFragment_to_impactosFragment2);
            }
        });
