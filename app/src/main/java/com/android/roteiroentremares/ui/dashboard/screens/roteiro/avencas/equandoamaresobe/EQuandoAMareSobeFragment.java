...
public class EQuandoAMareSobeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_e_quando_a_mare_sobe, container, false);
        ...
        switch (id) {
            case R.id.item_text_to_speech:
                if (tts.isSpeaking()) {
                    ...
                    String text = "Quando a maré enche, submergindo estas plataformas de rocha o que acontecerá aos organismos que aqui vivem?";
    ...
    private void initViews(View view) {
        ...
        Uri uri = Uri.parse("android.resource://" + getActivity().getPackageName() + "/" + R.raw.vid_equandoamaresobe);
    ...
    private void insertContent() {
        textViewContent.setText(HtmlCompat.fromHtml(
                "Quando a maré enche, submergindo estas plataformas de rocha o que acontecerá aos organismos que aqui vivem?",
