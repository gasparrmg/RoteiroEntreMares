...
public class HistoriasPassadoFragment16 extends Fragment {
    ...
    private int imageResourceId = R.drawable.img_historiaspassado_argilitos;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_historias_passado16, container, false);
                ...
                if (ttsEnabled) {
                    if (tts.isSpeaking()) {
                        ...
                        String text = HtmlCompat.fromHtml(
                                "Argilitos e arenitos presentes na arriba",
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_historiasPassadoFragment16_to_historiasPassadoFragment17);
            }
        });
