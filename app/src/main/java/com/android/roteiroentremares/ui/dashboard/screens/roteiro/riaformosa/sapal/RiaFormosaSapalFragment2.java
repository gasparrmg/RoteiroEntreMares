...
public class RiaFormosaSapalFragment2 extends Fragment {

    private static final String htmlContent = "Dirige-te para a zona do Sapal " +
            "<b>(assinalada com o número 4 na imagem)</b>";

    private static final int imageResourceId = R.drawable.img_riaformosa_sapal_ponto4;
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaSapalFragment2_to_riaFormosaSapalFragment3);
            }
        });
