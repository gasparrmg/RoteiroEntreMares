...
public class BiodiversidadeInteracoesHerbivoriaFragment extends Fragment {

    private static final String htmlContent = "As lapas são organismos herbívoros, que se vão deslocando sobre o substrato e raspando, com a rádula (uma estrutura com dentes), as algas que cobrem a rocha. Este comportamento garante o equilíbrio destes ecossistemas, ao impedir que as algas se desenvolvam demasiado, cobrindo todo o substrato.";
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_biodiversidadeInteracoesHerbivoriaFragment_to_biodiversidadeInteracoesHerbivoriaFragment2);
            }
        });
    }
