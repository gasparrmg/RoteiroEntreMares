...
@AndroidEntryPoint
public class ImpactosPoluicaoFragment2 extends Fragment {
    ...
    private final int imageResourceId = R.drawable.img_impactos_poluicao;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_impactos_poluicao2, container, false);
            ...
            case R.id.item_text_to_speech:
                if (tts.isSpeaking()) {
                    ...
                    String text = HtmlCompat.fromHtml(
                            "Em menos de um século de existência os detritos de plástico já representam cerca de 60 a 80% do lixo marinho.<br><br><b>Uma forma de evitar que este cenário se torne realidade, será reduzir ao máximo o uso de plásticos.</b>",
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // set path as done
                dashboardViewModel.setImpactosPoluicaoAsFinished();
