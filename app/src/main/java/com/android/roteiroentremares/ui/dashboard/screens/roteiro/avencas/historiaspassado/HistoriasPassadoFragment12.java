...
public class HistoriasPassadoFragment12 extends Fragment {
    ...
    private int imageResourceId = R.drawable.img_historiaspassado_falha;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_historias_passado12, container, false);
            ...
            case R.id.item_text_to_speech:
                if (tts.isSpeaking()) {
                    ...
                    String text = HtmlCompat.fromHtml(
                            "Observa com atenção os estratos presentes na parede rochosa, de cada lado da <b>falha</b>...",
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_historiasPassadoFragment12_to_historiasPassadoFragment13);
            }
        });
