...
@AndroidEntryPoint
public class RiaFormosaDunasFragmentDunaPrimaria3Tarefa extends Fragment {

    private static final String ZONA = "Duna primária";
                ...
                if (quadrado1Finished) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Substituir", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            RiaFormosaDunasFragmentDunaPrimaria3TarefaDirections.ActionRiaFormosaDunasFragmentDunaPrimaria3TarefaToNewAvistamentoDunasFragment action = RiaFormosaDunasFragmentDunaPrimaria3TarefaDirections.actionRiaFormosaDunasFragmentDunaPrimaria3TarefaToNewAvistamentoDunasFragment(ZONA, 1);
                ...
                if (quadrado2Finished) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Substituir", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            RiaFormosaDunasFragmentDunaPrimaria3TarefaDirections.ActionRiaFormosaDunasFragmentDunaPrimaria3TarefaToNewAvistamentoDunasFragment action = RiaFormosaDunasFragmentDunaPrimaria3TarefaDirections.actionRiaFormosaDunasFragmentDunaPrimaria3TarefaToNewAvistamentoDunasFragment(ZONA, 2);
                            Navigation.findNavController(view).navigate(action);
                        }
                    });
                    materialAlertDialogBuilder.setNegativeButton("Fechar", new DialogInterface.OnClickListener() {
                ...
                if (quadrado3Finished) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Substituir", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            RiaFormosaDunasFragmentDunaPrimaria3TarefaDirections.ActionRiaFormosaDunasFragmentDunaPrimaria3TarefaToNewAvistamentoDunasFragment action = RiaFormosaDunasFragmentDunaPrimaria3TarefaDirections.actionRiaFormosaDunasFragmentDunaPrimaria3TarefaToNewAvistamentoDunasFragment(ZONA, 3);
                            Navigation.findNavController(view).navigate(action);
                        }
                    });
                    materialAlertDialogBuilder.setNegativeButton("Fechar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!(quadrado1Finished && quadrado2Finished && quadrado3Finished)) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            dashboardViewModel.setRiaFormosaDunasDunaPrimariaAsFinished();
