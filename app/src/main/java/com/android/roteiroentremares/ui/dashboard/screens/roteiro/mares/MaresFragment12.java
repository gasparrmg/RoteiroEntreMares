...
public class MaresFragment12 extends Fragment implements View.OnClickListener{

    private static final String htmlContent = "Em alguns lugares ocorre apenas uma maré alta e uma maré baixa por dia, isto deve-se:";
                ...
                if (!isCorrect) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Navigation.findNavController(view).navigate(R.id.action_maresFragment12_to_maresFragment13);
                        }
                    });
