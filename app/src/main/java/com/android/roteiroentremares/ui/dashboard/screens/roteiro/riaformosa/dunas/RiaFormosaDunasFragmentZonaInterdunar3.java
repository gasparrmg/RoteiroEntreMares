...
public class RiaFormosaDunasFragmentZonaInterdunar3 extends Fragment {

    private static final String htmlContent = "<b>Dirige-te para uma zona entre dunas.</b><br><br>" +
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_riaFormosaDunasFragmentZonaInterdunar3_to_riaFormosaDunasFragmentZonaInterdunar4Tarefa);
            }
        });
    }
