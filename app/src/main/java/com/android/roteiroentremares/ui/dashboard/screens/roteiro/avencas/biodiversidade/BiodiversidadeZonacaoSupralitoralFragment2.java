...
@AndroidEntryPoint
public class BiodiversidadeZonacaoSupralitoralFragment2 extends Fragment {
    ...
    private static final String QUERY = "SELECT * FROM especie_table_avencas " +
            ...
            "nomeCientifico = 'Verrucaria maura'";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_biodiversidade_zonacao_supralitoral2, container, false);
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_biodiversidadeZonacaoSupralitoralFragment2_to_biodiversidadeZonacaoSupralitoralFragment3);
            }
        });
    }
