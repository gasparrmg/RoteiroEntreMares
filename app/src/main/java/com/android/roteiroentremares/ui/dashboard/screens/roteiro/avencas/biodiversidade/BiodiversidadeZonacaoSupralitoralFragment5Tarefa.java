...
@AndroidEntryPoint
public class BiodiversidadeZonacaoSupralitoralFragment5Tarefa extends Fragment {

    private static final String ZONA = "Supralitoral";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_biodiversidade_zonacao_supralitoral5_tarefa, container, false);
    ...
    private void setOnClickListeners(View view) {
                ...
                if (quadrado1Finished) {
                    ...
                    materialAlertDialogBuilder.setPositiveButton("Substituir", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BiodiversidadeZonacaoSupralitoralFragment5TarefaDirections.ActionBiodiversidadeZonacaoSupralitoralFragment5TarefaToNewEditAvistamentoZonacaoFragment action = BiodiversidadeZonacaoSupralitoralFragment5TarefaDirections.actionBiodiversidadeZonacaoSupralitoralFragment5TarefaToNewEditAvistamentoZonacaoFragment(ZONA, 1);
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dashboardViewModel.setBiodiversidadeZonacaoSupralitoralAsFinished();
