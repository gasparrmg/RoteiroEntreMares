...
public class BiodiversidadeZonacaoSupralitoralFragment extends Fragment {

    private static final String htmlContent = "Zona que se encontra imediatamente acima do limite máximo da maré-cheia.  Está sujeito à aspersão por gotículas de água provenientes das ondas.";
    ...
    private final int[] imageResourceIds = {
            R.drawable.img_biodiversidade_zonacao_supralitoral_1,
            R.drawable.img_biodiversidade_zonacao_supralitoral_2
    };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_biodiversidade_zonacao_supralitoral, container, false);
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_biodiversidadeZonacaoSupralitoralFragment_to_biodiversidadeZonacaoSupralitoralFragment2);
            }
        });
