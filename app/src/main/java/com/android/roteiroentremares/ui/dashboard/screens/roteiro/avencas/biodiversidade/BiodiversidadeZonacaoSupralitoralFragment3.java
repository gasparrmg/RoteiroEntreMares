...
public class BiodiversidadeZonacaoSupralitoralFragment3 extends Fragment implements EasyPermissions.PermissionCallbacks {

    private final String htmlContent = "Dirige-te agora para o ponto assinalado com as coordenadas GPS: 38.68975, -9.36352.<br><br>Carrega no botão das direções para encontrares o local. Poderás passar para o próximo ecrã assim que te encontrares perto do local.";
    private final String spotCoordinates = "38.68975,-9.36352";
    private final double spotLatitude = 38.68975;
    private final double spotLongitude = -9.36352;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_biodiversidade_zonacao_supralitoral3, container, false);
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_biodiversidadeZonacaoSupralitoralFragment3_to_biodiversidadeZonacaoSupralitoralFragment4);
            }
        });
