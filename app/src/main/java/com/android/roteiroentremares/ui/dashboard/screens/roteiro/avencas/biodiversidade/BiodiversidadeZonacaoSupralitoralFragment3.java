...
public class BiodiversidadeZonacaoSupralitoralFragment3 extends Fragment implements EasyPermissions.PermissionCallbacks {
    ...
    private final String htmlContent = "Dirige-te agora para o ponto assinalado com as coordenadas GPS: 38.68975, -9.36352.<br><br>Carrega no botão das direções para encontrares o local. Só deverás passar para o próximo ecrã quando te encontrares perto do local.";
