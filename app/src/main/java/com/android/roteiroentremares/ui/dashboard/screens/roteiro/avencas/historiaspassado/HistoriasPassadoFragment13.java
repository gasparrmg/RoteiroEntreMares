...
public class HistoriasPassadoFragment13 extends Fragment {
    ...
    private int imageResourceId = R.drawable.img_historiaspassado_falha_praia_bafureira;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_historias_passado13, container, false);
                ...
                if (ttsEnabled) {
                    if (tts.isSpeaking()) {
                        ...
                        String text = HtmlCompat.fromHtml(
                                "Pormenor da falha existente na arriba da Praia da Bafureira...",
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_historiasPassadoFragment13_to_historiasPassadoFragment14);
            }
        });
