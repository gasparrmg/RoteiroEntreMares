...
public class MaresFragment2 extends Fragment {

    private static final String htmlContent = "Conforme a rotação da Terra, cada região passa por duas marés em cada dia. Podemos dizer, então, que em pontos opostos temos duas marés altas e duas marés baixas, alternado a cada 6 horas aproximadamente.<br>" +
            "<br>" +
    ...
    private void setOnClickListeners(View view) {
        ...
        buttonFabNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_maresFragment2_to_maresFragment3);
            }
        });
    }
